...
#define RCV_MAX_BYTES 30

// Sensores analogicos
extern unsigned short sharpRes;		  // Lectura de la medida del sensor infrarrojo
extern unsigned short sharpResA[MAX_SHARP];  // Arreglo de Lecturas del Sharp
extern unsigned short sharpResM;         // Valor medio de ultimas MAX_SHARP Lecturas del Sharp
...
// Variables de camara
extern unsigned short xDesv;	

// comunicacion camara
//AS1_TComData charRcv[1] = {'\0'};
//AS1_TComData blockRcv[100] = "";
//word bytesRcv = 0;
//bool camWait = FALSE;

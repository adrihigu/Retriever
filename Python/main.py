...
def main():
    ...
    filename = os.path.join(dirname, 'calibration.yaml')
    ...
    group.add_argument("-m", "--matrix",  type=str, default=filename,help="Calibration file")
    ...
    ar_tracker = ARTracker(debug_flag = args["debug"], marker_size = 0.148, field_width = 1, field_length = 1)
    ...
    while (1):
        ...
        #     col_tracker.tracked_colors.append((255,0,0));
        # if cv2.waitKey(1) & 0xFF == ord('g'):
        #     col_tracker.tracked_colors.append((0,255,0));
        # if cv2.waitKey(1) & 0xFF == ord('b'):
        #     col_tracker.tracked_colors.append((0,0,255));
        # if cv2.waitKey(1) & 0xFF == ord('c'):
        #     col_tracker.tracked_colors.append((0,255,255));
        # if cv2.waitKey(1) & 0xFF == ord('y'):
        #     col_tracker.tracked_colors.append((255,255,0));
